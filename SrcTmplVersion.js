var newVersion = {
    ...
    "SrcJudesc":{
        ...
        "3.4":"1.增加支持视界聚合竖屏分栏搜索样式；2.增加支持预处理代码；3.预加载代码优化；4.二级增加自定义中间扩展组件返回属性；5.主页选源支持hikerPop新样式；6.累积更新；20240906",
        "3.5":"1.更换图标彩佬新地址；2.二级返回增加type属性以便支持下载；3.去除二级解析判断子页面提示；4.其他累积小优化；20241203",
        "3.6":"旧版本不再维护，新版本聚阅发布"
    }
};
